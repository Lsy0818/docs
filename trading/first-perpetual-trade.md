...
6. Select a perpetual market from the market selector.
7. Choose **Long** if you expect the market price to rise, or **Short** if you expect it to fall.
8. Select a **Market** or **Limit** order.
9. Enter the order size and review the required margin.
10. Set leverage within the market's permitted range.
11. Review the estimated entry price, fees, liquidation price, and other order details.
12. Submit the order.
13. Monitor the order or position from the relevant account panel.
